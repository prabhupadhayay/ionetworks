<?php
	...
	$pageName = "Documentation Page CMS";
	$pageURL = 'documentation-cms.php';
	$tableName = 'doc_cms';
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			$result = $admin->docFormCMS($_POST,$_FILES);
						...
						<form action="" id="form" method="post" enctype="multipart/form-data" autocomplete="off">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title mb-0"> Documentation Banner Details</h4>
								</div>
								<div class="card-body">
