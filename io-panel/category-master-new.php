<?php
	...
	$pageName = "Category-new";
	$pageURL = 'category-master-new.php';
	$addURL = 'category-add-new.php';
	$deleteURL = 'category-master-new.php';
	$tableName = 'new_category_master';
							...
							<tbody>
								...
								?>
										<tr>
											...
											<td>
												<a href="sub-category-master.php?cat_id=<?php echo $row['id'] ?>" name="edit" class="">View Sub Categories</a>
											</td>
											<td>
