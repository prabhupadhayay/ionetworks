<?php
	...
	$pageName = "Partnership Form Page CMS";
	$pageURL = 'partnership-cms.php';
	$tableName = 'partnership_form_cms';
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			$result = $admin->partnershipFormCMS($_POST,$_FILES);
						...
						<form action="" id="form" method="post" enctype="multipart/form-data" autocomplete="off">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title mb-0"> Partnership Banner Details</h4>
								</div>
								<div class="card-body">
									<div class="form-group row">
										<div class="col-sm-4">
											...
											<span class="help-text">
												...
												Images must be exactly <strong>1349 x 125</strong> pixels.
											</span>
											<?php 
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('input[name="image_name"]').change(function(){
				loadImagePreview(this, (1349 / 215));
			});
