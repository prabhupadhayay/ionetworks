<?php
	...
	$parentPageURL = 'about-us-cms.php';
								...
								<div class="card-body">
									<div class="form-group row">
										<div class="col-md-4">
											...
											<span class="help-text">
												...
												Images must be exactly <strong>167 x 167</strong> pixels.
											</span>
											<?php if(isset($_GET['edit'])) {
											...
											?>
												<img src="../images/testimonial/<?php echo $file_name.'_crop.'.$ext ?>" width="200" />
											<?php
											} ?>
										</div>
										...
										<div class="col-sm-4">
											...
											<input type="text" required class="form-control" name="designation" id="" value="<?php if(isset($_GET['edit'])){ echo $data['designation']; }?>"/>
										</div>
									</div>
									...
									<div class="form-group row">
										<div class="col-sm-3">
											...
											<textarea class="form-control" name="description" required><?php if(isset($_GET['edit'])){ echo $data['description']; } ?></textarea>
										</div>
										<div class="col-sm-4">
											<label>Display Order <em>*</em></label>
											<input type="text" required class="form-control" name="display_order" id="" value="<?php if(isset($_GET['edit'])){ echo $data['display_order']; }?>"/>
										</div>
										<div class="col-sm-4">
											<label>Active</label>
