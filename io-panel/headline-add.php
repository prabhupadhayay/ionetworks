<?php
	...
	$pageName = "Headline Master";
	$parentPageURL = 'headline-master.php';
	$pageURL = 'headline-add.php';
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			$result = $admin->addHomeHeadline($_POST, $_FILES);
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueHomeHeadlineById($id);
	}

	if(isset($_POST['id']) && !empty($_POST['id'])) {
		if($csrf->check_valid('post')) {
			$id = trim($admin->escape_string($admin->strip_all($_POST['id'])));
			$result = $admin->updateHomeHeadline($_POST, $_FILES);
									...
									<div class="form-group row">
										<div class="col-md-4">
											...
											<span class="help-text">
												...
												Images must be exactly <strong>990 x 536</strong> pixels.
											</span>
											<?php if(isset($_GET['edit'])) {
