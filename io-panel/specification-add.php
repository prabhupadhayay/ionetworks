<?php
	...
	$pageName = "Product Specification";
	$pageURL = 'specification-add.php';
	...
	if(isset($_GET['industryId'])){
		...
		$parentPageURL = 'product-add.php?edit&id='.$industryId;
	}else{
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addProductSpecification($_POST, $_FILES);
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueProductSpecificationById($id);
	}
	...
	if(isset($_POST['id']) && !empty($_POST['id'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateProductSpecification($_POST, $_FILES);
								...
								<div class="card-body">
									...
									<div class="form-group row">
										<div class="col-md-4">
											...
											<span class="help-text">
												...
												Images must be exactly <strong>120 x 120</strong> pixels.
											</span>
											<?php if(isset($_GET['edit'])) {
											...
											?>
												<img src="../images/product/<?php echo $file_name.'_crop.'.$ext ?>" width="200" />
											<?php
											} ?>
										</div>
										<div class="col-sm-4">
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											...
											<textarea name="description" id="description" row="7" class="form-control"><?php if(isset($_GET['edit'])){ echo $data['description']; }?></textarea>
										</div>
									</div>
								</div>
							</div>
