<?php
	...
	$pageURL = 'industry-empower-master.php';
	$addURL = 'industry-empower-add.php';
	$deleteURL = 'industry-empower-master.php';
	$tableName = 'industry_empower_master';
						...
						<table class="table table-striped custom-table mb-0 datatable datatable-selectable-data">
							<thead>
								<tr>
									...
									<th>Industry Name 2</th>
									<th>Industry Name 3</th>
									<th>Active</th>
									<th>Action</th>
								</tr>
							</thead>
							<tbody>
								<?php
									...
									while($row = $admin->fetch($results)){
										...
										$industryName1 = $admin->getUniqueIndustryById($row['industry1']);
										$industryName2 = $admin->getUniqueIndustryById($row['industry2']);
										$industryName3 = $admin->getUniqueIndustryById($row['industry3']);
								?>
										<tr>
											<td><?php echo $x++ ?></td>
											<td><?php echo $industryName1['name']; ?></td>
											<td><?php echo $industryName2['name']; ?></td>
											<td><?php echo $industryName3['name']; ?></td>
											<td>
