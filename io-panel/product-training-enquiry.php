<?php
	...
	$pageName = "Product Training Enquiry";
	$tableName = 'product_training_details';
	$deleteURL = 'product-training-enquiry.php';
	$pageURL = 'product-training-enquiry.php';
	...
	if(isset($_GET['delId']) && !empty($_GET['delId']) ){
		...
		$admin->deleteProductTrainingEnquiry($delId);
