<?php
	...
	$pageName = "Product Varient";
	$parentPageURL = 'varient-master.php';
	$pageURL = 'varient-add.php';
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			$result = $admin->addVarient($_POST, $_FILES);
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueVarientById($id);
	}

	if(isset($_POST['id']) && !empty($_POST['id'])) {
		if($csrf->check_valid('post')) {
			$id = trim($admin->escape_string($admin->strip_all($_POST['id'])));
			$result = $admin->updateVarient($_POST, $_FILES);
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="form-group row">
										<div class="col-md-4">
											<label>Varient Name <em>*</em></label>
