<?php
	...
	$pageURL = 'home-testimonial-master.php';
	$addURL = 'home-testimonial-add.php';
	$deleteURL = 'home-testimonial-master.php';
	$tableName = 'home_testimonial_master';
	...
	if(isset($_GET['delId']) && !empty($_GET['delId']) ){
		...
		$admin->deleteHomeTestimonial($delId);
