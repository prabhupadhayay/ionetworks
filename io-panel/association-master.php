<?php
	...
	$pageURL = 'association-master.php';
	$addURL = 'association-add.php';
	$deleteURL = 'association-master.php';
	$tableName = 'association_master';
							...
							<tbody>
								<?php
									...
									while($row = $admin->fetch($results)){
										...
										$url =  BASE_URL."/images/association/".$row['image_name'];
								?>
										<tr>
											<td><?php echo $x++ ?></td>
