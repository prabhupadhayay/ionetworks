<?php
	...
	$pageName = "Togather Image";
	$parentPageURL = 'togimg-master.php';
	$pageURL = 'togimg-add.php';
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			$result = $admin->addTogatherImage($_POST, $_FILES);
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueTogatherImageById($id);
	}

	if(isset($_POST['update']) && !empty($_POST['id'])) {
		if($csrf->check_valid('post')) {
			$id = trim($admin->escape_string($admin->strip_all($_POST['id'])));
			$result = $admin->updateTogatherImage($_POST, $_FILES);
						...
						<form action="" id="form" method="post" enctype="multipart/form-data" autocomplete="off">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title mb-0"> Partner Onboard Details</h4>
								</div>
								<div class="card-body">
									<div class="form-group row">
										<div class="col-sm-4">
											...
											<span class="help-text">
												...
												Images must be exactly <strong>230 x 127</strong> pixels.
											</span>
											<?php 
											...
											?>
													<br><img src="../images/partner/<?php echo $file_name.'_crop.'.$ext ?>" width="200"  />
											<?php
											} ?>
										</div>
										<div class="col-sm-4">
									...
									<div class="form-group row">
										<div class="col-sm-4">
											...
											<textarea class="form-control" name="description"><?php if(isset($_GET['edit'])) { echo $data['description']; } ?></textarea>
										</div>
									</div>
								</div>
							</div>
