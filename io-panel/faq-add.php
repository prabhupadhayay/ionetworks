<?php
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			$result = $admin->addFAQ($_POST, $_FILES);
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueFAQById($id);
	}

	if(isset($_POST['id']) && !empty($_POST['id'])) {
		if($csrf->check_valid('post')) {
			$id = trim($admin->escape_string($admin->strip_all($_POST['id'])));
			$result = $admin->updateFAQ($_POST, $_FILES);
								...
								<div class="card-body">
									...
									<div class="form-group row">
										<div class="col-md-12">
											...
											<textarea name="question" class="form-control" rows="3" required><?php if(isset($_GET['edit'])) { echo $data['question']; } ?></textarea>
										</div>
									</div>
									<div class="form-group row">
										<div class="col-md-12">
											<label>Answer <em>*</em></label>
											<textarea name="answer" id="answer" class="form-control" rows="3" required><?php if(isset($_GET['edit'])) { echo $data['answer']; } ?></textarea>
										</div>
									</div>
									<div class="form-group row">
										<div class="col-sm-4">
											...
											<select class="form-control" name="category_id">
												<?php 
													$category = $admin->getAllSubCategories();
													while($categoryDetails = $admin->fetch($category)) {
												?>
													<option value="<?php echo $categoryDetails['id']; ?>" <?php if(isset($_GET['edit']) and $data['category_id']== $categoryDetails['id']) { echo 'selected'; } ?>><?php echo $categoryDetails['category_name']; ?></option>
												<?php } ?>
