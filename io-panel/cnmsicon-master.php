<?php
	...
	$pageURL = 'cnmsicon-master.php';
	$addURL = 'cnmsicon-add.php';
	$deleteURL = 'cnmsicon-master.php';
	$tableName = 'cnmsicon_master';
							...
							<tbody>
								<?php
									...
									while($row = $admin->fetch($results)){
										...
										$url =  BASE_URL."/images/cnms/".$file_name.'_crop.'.$ext;
								?>
										<tr>
											<td><?php echo $x++ ?></td>
