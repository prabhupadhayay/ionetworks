<?php
	...
	$pageURL = 'emsicon-master.php';
	$addURL = 'emsicon-add.php';
	$deleteURL = 'emsicon-master.php';
	$tableName = 'emsicon_master';
							...
							<tbody>
								<?php
									...
									while($row = $admin->fetch($results)){
										...
										$url =  BASE_URL."/images/ems/".$file_name.'_crop.'.$ext;
								?>
										<tr>
											<td><?php echo $x++ ?></td>
