<?php
	...
	$pageName = "Address";
	$parentPageURL = 'address-master.php';
	$pageURL = 'address-add.php';
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueAddressById($id);
	}

	if(isset($_POST['id']) && !empty($_POST['id'])) {
		if($csrf->check_valid('post')) {
			$id = trim($admin->escape_string($admin->strip_all($_POST['id'])));
			$result = $admin->updateAddress($_POST);
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="form-group row">
										<div class="col-sm-4">
											<label>Office Name <em>*</em></label>
											<input type="text" required class="form-control" name="name" id="" value="<?php if(isset($_GET['edit'])){ echo $data['name']; }?>"/>
										</div>
										<div class="col-sm-4">
											<label>Address <em>*</em></label>
											<textarea name="address" class="form-control"><?php if(isset($_GET['edit'])){ echo $data['address']; }?></textarea>
										</div>
										<div class="col-sm-4">
											<label>Telephone</label>
											<input type="text" class="form-control" name="telephone" id="" value="<?php if(isset($_GET['edit'])){ echo $data['telephone']; }?>"/>
										</div>
									...
									<div class="form-group row">
										<div class="col-sm-4">
											<label>Email</label>
											<input type="text" class="form-control" name="email" id="" value="<?php if(isset($_GET['edit'])){ echo $data['email']; }?>"/>
										</div>
										<div class="col-sm-4">
											<label>Fax</label>
											<input type="text" class="form-control" name="fax" id="" value="<?php if(isset($_GET['edit'])){ echo $data['fax']; }?>"/>
										</div>
										<div class="col-sm-4">
											<label>Office Type</label>
											<select class="form-control" name="office_type">
												<option value="Corporate Office" <?php if(isset($_GET['edit']) and $data['office_type']=='Corporate Office') { echo 'selected'; } ?>>Corporate Office</option>
												<option value="Excellence Office" <?php if(isset($_GET['edit']) and $data['office_type']=='Excellence Office') { echo 'selected'; } ?>>Excellence Office</option>
											</select>
										</div>
