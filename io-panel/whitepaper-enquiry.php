...
$pageName = "Whitepaper Enquiry";
$tableName = 'whitepaper_enquiries';
$deleteURL = 'whitepaper-enquiry.php';
$pageURL = 'whitepaper-enquiry.php';
...
if (isset($_GET['delId']) && !empty($_GET['delId'])) {
	...
	$admin->deleteWhitepaperEnquiry($delId);
							...
							<tbody>
								...
								?>
									<tr>
										...
										<td><?php echo date('d F, Y G:ia', strtotime($row['created_at'])); ?></td>
										<td>
