<?php
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			$result = $admin->updateEMSCMS($_POST,$_FILES);
						...
						<form action="" id="form" method="post" enctype="multipart/form-data" autocomplete="off">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title mb-0"> EMS Details</h4>
								</div>
								<div class="card-body">
									<div class="form-group row">
										<div class="col-sm-4">
											...
											<span class="help-text">
												...
												Images must be exactly <strong>1349 x 533</strong> pixels.
											</span>
											<?php 
										...
										<div class="col-sm-4">
											<label>Banner Url(Get Demo)<em>*</em></label>
									...
									<div class="form-group row">
										<div class="col-sm-4">
											...
											<input type="file" class="form-control file" name="faq_banner" id="" data-image-index="1" />
											<span class="help-text">
												Files must be less than <strong>2 MB</strong>.<br>
												Allowed file types: <strong>png jpg jpeg</strong>.<br>
												Images must be exactly <strong>1934 x 860</strong> pixels.
											</span>
											<?php 
												if(!empty($data['faq_banner'])) {
													$file_name = str_replace('', '-', strtolower( pathinfo($data['faq_banner'], PATHINFO_FILENAME)));
													$ext = pathinfo($data['faq_banner'], PATHINFO_EXTENSION);
											?>
													<br><img src="../images/slider-banner/<?php echo $file_name.'_crop.'.$ext ?>" width="200"  />
											<?php
											} ?>
									...
									<div class="form-group row">
										<div class="col-sm-12">
											<label>Technology Description <em>*</em></label>
											<textarea class="form-control" name="technology_description" id="technology_description"><?php echo $data['technology_description']; ?></textarea>
										</div>
									</div>
									<div class="form-group row">
										<div class="col-sm-12">
											<label>Technology Url(Get Demo)<em>*</em></label>
											<input type="text" class="form-control" name="technology_url" value="<?php echo $data['technology_url']; ?>" required>
										</div>
									</div>
								</div>
							</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('input[name="image_name"]').change(function(){
				loadImagePreview(this, (1349 / 533));
			});

			$('input[name="faq_banner"]').change(function(){
				loadImagePreview(this, (1934 / 860));
			});
