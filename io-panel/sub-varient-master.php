<?php
	...
	$pageURL = 'sub-varient-master.php';
	$addURL = 'sub-varient-add.php';
	$deleteURL = 'sub-varient-master.php';
	$tableName = 'sub_varient_master';
							...
							<tbody>
								<?php
									...
									while($row = $admin->fetch($results)){
										$varientDetails = $admin->getUniqueVarientById($row['varient_id']);
								...
								?>
										<tr>
											...
											<td><?php echo $varientDetails['name']; ?></td>
