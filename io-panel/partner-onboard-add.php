<?php
	...
	$parentPageURL = 'partner-onboard-master.php';
	$pageURL = 'partner-onboard-add.php';
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			$result = $admin->addPartnerOnboard($_POST, $_FILES);
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniquePartnerOnboardById($id);
	}

	if(isset($_POST['update']) && !empty($_POST['id'])) {
		if($csrf->check_valid('post')) {
			$id = trim($admin->escape_string($admin->strip_all($_POST['id'])));
			$result = $admin->updatePartnerOnboard($_POST, $_FILES);
									...
									<div class="form-group row">
										<div class="col-sm-4">
											...
											<span class="help-text">
												...
												Images must be exactly <strong>108 x 80</strong> pixels.
											</span>
											<?php 
