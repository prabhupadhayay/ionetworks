<?php
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addClassLead($_POST, $_FILES);
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueClassLeadById($id);
	}
	...
	if(isset($_POST['id']) && !empty($_POST['id'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateClassLead($_POST, $_FILES);
									...
									<div class="form-group row">
										<div class="col-md-4">
											...
											<span class="help-text">
												...
												Images must be exactly <strong>70 x 70</strong> pixels.
											</span>
											<?php if(isset($_GET['edit'])) {
