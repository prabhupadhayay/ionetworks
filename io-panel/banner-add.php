									...
									<div class="form-group row">
										<div class="col-md-4">
											...
											<span class="help-text">
												...
												Images must be exactly <strong>818 x 552</strong> pixels.
											</span>
											<?php if(isset($_GET['edit'])) {
										...
										<div class="col-sm-4">
											...
											<input type="text" required class="form-control" name="title1" id="" value="<?php if(isset($_GET['edit'])){ echo $data['title1']; }?>"/>
										</div>
										<div class="col-sm-4">
											<label>Title 2 <em>*</em></label>
											<input type="text" required class="form-control" name="title2" id="" value="<?php if(isset($_GET['edit'])){ echo $data['title2']; }?>"/>
										</div>
