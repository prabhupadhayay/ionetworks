<?php 
   ...
   $cmsDetails = $functions->gerCMSDetailsByPageName('legal');
...
<html>
<head>
	<title><?php echo $websitename; ?> || Partner Program Agreement </title>
		...
		<section class="innerpagebanner-section mtop">
			...
			<div class="inbantext">
				<div class="container p0">
					<h1 class="wow fadeInUp" data-wow-delay="0.5s">Partner Program Agreement</h1>
				</div>
			</div>
		</section>
		...
		<section class="breadcrumb-section">
			<div class="container p0">
				<ul class="breadcrumb-in">
					...
					<li class="wow fadeIn" data-wow-delay="0.55s"><a href="javascript:void(0);">Partner Program Agreement</a></li>
				</ul>
			</div>
		</section>
